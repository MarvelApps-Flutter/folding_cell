...
class SimpleFoldingCell extends StatefulWidget {
  SimpleFoldingCell.create(
      {Key? key,
        ...
        required this.secondInnerWidgets,
        this.cellSize = const Size(100.0, 125.0),
  ...
  final Widget? secondInnerWidgets;
  ...
  void initState() {
    ...
    _animationController.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
        ...
        {
          print("widget.onOpen is ${widget.onOpen}");
          widget.onOpen!();
        }
                      ...
                      child: OverflowBox(
                        ...
                        child: ClipRect(
                          child: Align(
                            heightFactor: 0.5,
                            alignment: Alignment.topCenter,
                            child: widget.secondInnerWidgets,
                          ),
                        ),
                      ),
                    ),
